...
public enum TournamentType {
    ...
    TournamentType(String name, int demoId, int minPlayers, int maxPlayers, boolean eliminating, String pictureUrl, String description) {
        this.id = this.name();
        this.name = name;
        this.demoId = demoId;
