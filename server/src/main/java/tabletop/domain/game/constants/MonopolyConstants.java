...
public class MonopolyConstants {
    public static String description = "Monopoly is a board game that originated in the United States in 1903 as a way to " +
    ...
    public static String longDescription = "Subtitled \"The Fast-Dealing Property Trading Game\", the game is " +
    ...
    public static String imageUrl = "http://www.stonecoldmagicmagazine.com/images/free-tricks/monopoly-man2.png";

    public static String bannerUrl = "http://bi.gazeta.pl/im/59/43/12/z19151705IER,Monopoly-Krakow.jpg";
}
